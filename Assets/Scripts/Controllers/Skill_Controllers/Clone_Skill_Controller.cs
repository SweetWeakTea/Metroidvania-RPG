...
public class Clone_Skill_Controller : MonoBehaviour
{
    ...
    private float chanceToDuplication;
                           ...
                           float _chanceToDuplicate, Player _player, float _attackMultiplier)
    {
        ...
        chanceToDuplication = _chanceToDuplicate;
    ...
    private void AttackTrigger()
    {
        ...
        foreach (var hit in colliders)
        {
            if (hit.GetComponent<Enemy>() != null)
            {
                ...
                if (player.skill.clone.canApplyOnHitEffect) // 分身触发装备效果
                {
                ...
                {
                    if (Random.Range(0, 100) < chanceToDuplication)
                    {
